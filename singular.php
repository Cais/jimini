...
/**
 * The Jimini Theme
 * A jumping good look for WordPress sites.
 *
 * @package   Jimini
 * @version   0.1
 *
		...
		<div class="content-and-sidebar">
			...
			<div class="content-wrapper">
				...
				<div class="content-without-sidebar">
					...
					$jimini_content->the_loop();

					// Navigation between posts.
					$jimini_navigation = JiminiNavigation::create_instance();
					$jimini_navigation->post_to_post_navigation();
					$jimini_navigation->post_to_post_navigation_via_categories();
					$jimini_navigation->post_to_post_navigation_via_tags(); ?>
